...
var _$Hxx4Dom_Hxx4Dom_$Impl_$ = {};
_$Hxx4Dom_Hxx4Dom_$Impl_$.__name__ = true;
_$Hxx4Dom_Hxx4Dom_$Impl_$.tag = function(name,args,children) {
	var ret = window.document.createElement(name);
	var _g = 0;
	var _g1 = Reflect.fields(args);
	while(_g < _g1.length) {
		var f = _g1[_g];
		++_g;
		if(f == "style") {
...
Main.__name__ = true;
Main.main = function() {
	var children = [vdom__$VNode_VNode_$Impl_$.toElement("2")];
	console.log(_$Hxx4Dom_Hxx4Dom_$Impl_$.tag("div",{ className : "foo"},children));
};
Math.__name__ = true;
...
vdom__$VNode_VNode_$Impl_$.toElement = function(this1) {
	return window.virtualDom.create(this1);
};
